  ...
  return (
    <div className="space-y-3 sm:space-y-4 md:space-y-6 lg:space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
        <div className="glass-card rounded-xl sm:rounded-2xl p-3 sm:p-5 md:p-6 border border-white/5 hover:border-blue-500/20 transition-all duration-300 md:col-span-2">
          <h2 className="text-base sm:text-lg md:text-xl font-semibold text-white mb-2 sm:mb-4">
            <i className="bi bi-hand-wave me-2"></i>Who I Am
          </h2>
        ...
        <div className="glass-card rounded-xl sm:rounded-2xl p-3 sm:p-5 md:p-6 border border-white/5 hover:border-purple-500/20 transition-all duration-300">
          <h2 className="text-base sm:text-lg md:text-xl font-semibold text-white mb-2 sm:mb-4">
            <i className="bi bi-bullseye me-2"></i>Quick Facts
          </h2>
          <div className="space-y-1.5 sm:space-y-3 text-xs sm:text-sm">
            <div className="flex items-center gap-1.5 sm:gap-3 p-1.5 sm:p-2 rounded-lg bg-[#1a2332]/30">
              <i className="bi bi-geo-alt-fill text-lg sm:text-2xl text-red-400"></i>
              <div>
            ...
            <div className="flex items-center gap-1.5 sm:gap-3 p-1.5 sm:p-2 rounded-lg bg-[#1a2332]/30">
              <i className="bi bi-mortarboard-fill text-lg sm:text-2xl text-blue-400"></i>
              <div>
            ...
            <div className="flex items-center gap-1.5 sm:gap-3 p-1.5 sm:p-2 rounded-lg bg-[#1a2332]/30">
              <i className="bi bi-briefcase-fill text-lg sm:text-2xl text-green-400"></i>
              <div>
            ...
            <div className="flex items-center gap-1.5 sm:gap-3 p-1.5 sm:p-2 rounded-lg bg-[#1a2332]/30">
              <i className="bi bi-lightbulb-fill text-lg sm:text-2xl text-yellow-400"></i>
              <div>
      ...
      <div className="glass-card rounded-xl sm:rounded-2xl p-3 sm:p-5 md:p-6 border border-white/5">
        <h2 className="text-base sm:text-lg md:text-xl font-semibold text-white mb-2 sm:mb-4">
          <i className="bi bi-rocket-takeoff me-2"></i>My Mission
        </h2>
        ...
        <div className="mt-2 sm:mt-4 flex flex-wrap gap-1 sm:gap-2">
          <span className="skill-tag text-[0.45rem] sm:text-xs"><i className="bi bi-seedling me-1"></i>Learning</span>
          <span className="skill-tag text-[0.45rem] sm:text-xs"><i className="bi bi-lightbulb me-1"></i>Innovation</span>
          <span className="skill-tag text-[0.45rem] sm:text-xs"><i className="bi bi-people-fill me-1"></i>Collaboration</span>
          <span className="skill-tag text-[0.45rem] sm:text-xs"><i className="bi bi-star-fill me-1"></i>Excellence</span>
        </div>
      </div>
    </div>
  );
