// App.js - Modern Navigation with Mobile Hamburger Menu
              ...
              <div className="py-3 space-y-1 border-t border-[#253141]/50">
                ...
                <div className="pt-3 mt-3 border-t border-[#253141]/30 px-4">
                  ...
                  <div className="flex gap-3">
                    <a href="https://github.com/b-fame" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-[#1f2a3a] flex items-center justify-center hover:bg-blue-500/20 transition-all duration-300 text-gray-400 hover:text-white">
                      <span className="text-sm">🐙</span>
                    </a>
                    <a href="https://www.linkedin.com/in/blaise-fame-759820418" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-[#1f2a3a] flex items-center justify-center hover:bg-blue-500/20 transition-all duration-300 text-gray-400 hover:text-white">
                      <span className="text-sm">💼</span>
                    </a>
                    <a href="https://www.instagram.com/__rutayisire/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-[#1f2a3a] flex items-center justify-center hover:bg-pink-500/20 transition-all duration-300 text-gray-400 hover:text-white">
                      <span className="text-sm">📸</span>
                    </a>
                  </div>
                </div>
