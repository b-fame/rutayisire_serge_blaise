      ...
      <div className="min-h-screen bg-[#0c0f14] text-gray-200 font-inter">
        <nav className="sticky top-0 z-50 bg-[#141b24]/80 backdrop-blur-md border-b border-[#253141] px-2 sm:px-4 py-2 sm:py-3 shadow-lg">
          <div className="max-w-5xl mx-auto flex flex-wrap items-center justify-between gap-1 sm:gap-4">
            <span className="text-xs sm:text-sm md:text-base lg:text-xl font-bold bg-gradient-to-r from-blue-300 to-purple-300 bg-clip-text text-transparent">
              🧑‍💻 <span className="hidden xs:inline">Serge Blaise</span>
            </span>
            <div className="flex flex-wrap gap-0.5 sm:gap-1.5 md:gap-2 text-[0.5rem] sm:text-xs md:text-sm">
